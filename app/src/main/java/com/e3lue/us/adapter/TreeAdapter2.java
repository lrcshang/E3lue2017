...
import com.kanade.treeadapter.TreeHelper;
...
public class TreeAdapter2<T extends RvTree> extends RecyclerView.Adapter<TreeAdapter2.TreeViewHolder> {
     ...
     * @param context
     */
    public TreeAdapter2(Context context) {
        mContext = context;
    }

    public TreeAdapter2(Context context, List<T> datas) {
        mContext = context;
        setNodes(datas);
    }
    ...
    @Override
    public void onBindViewHolder(TreeAdapter2.TreeViewHolder holder, int position) {
