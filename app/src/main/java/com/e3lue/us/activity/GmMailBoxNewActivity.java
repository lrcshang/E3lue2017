...
public class GmMailBoxNewActivity extends SwipeBackActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener {
    ...
    public GmMailBoxNewActivity.BaiduListenner myListener = new BaiduListenner();
    ...
    @BindView(R.id.GmMailBox_New_address)
    TextView address;

    @BindView(R.id.GmMailBox_New_recyclerView)
    RecyclerView recyclerView;

    @BindView(R.id.gmmailbox_new_progress)
    NumberProgressBar progressBar;

    @BindView(R.id.GmMailBox_New_info)
    EditText info;

    @BindView(R.id.GmMailBox_New_submit)
    Button submit;

    @OnClick(R.id.GmMailBox_New_submit)
    public void submit() {
        if (valid()) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gmmailbox_new_activity);
        ButterKnife.bind(this);

        textHeadTitle.setText("投信给总经理");
    ...
    public void save() {
        showProgress();
        OkGo.<String>post(HttpUrl.Url.GmMailBoxSave)
